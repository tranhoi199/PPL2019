...
class CodeGenVisitor(BaseVisitor, Utils):
    ...
    def visitVarDecl(self,ast,c):
        ...
        self.emit.printout(self.emit.emitVAR(indx, ast.variable, ast.varType, c.frame.getStartLabel(), c.frame.getEndLabel(), c.frame))
        return SubBody(c.frame, [Symbol(ast.variable, ast.varType, Index(indx))] + env)
    ...
    def genMETHOD(self, consdecl, o, frame):
        ...
        curenv = functools.reduce(lambda a,b: self.visit(b,a), lstdecl, glSubBody)
        
        lsArrVarDecl = list(filter(lambda x:type(x.varType) is ArrayType, lstdecl))
    ...
    def visitBlock(self,ast,c):
        ...
        varEnv = functools.reduce(lambda a,b: self.visit(b,a), lstdecl,SubBody(frame, newEnv))
