...
class ASTGenSuite(unittest.TestCase):
    ...
    def test_vardecl2(self):
        ...
        input = """int c[10];
            """
        expect = str(Program([VarDecl('c',ArrayType(10,IntType()))]))
        self.assertTrue(TestAST.checkASTGen(input,expect,305))
    def test_vardecl3(self):
        """Simple program: int main() {} """
        input = """int a,c[10];
            """
        expect = str(Program([VarDecl('a',IntType()),VarDecl('c',ArrayType(10,IntType()))]))
        self.assertTrue(TestAST.checkASTGen(input,expect,306))
    def test_vardecl4(self):
        """Simple program: int main() {} """
        input = """float a,c[10];
            """
        expect = str(Program([VarDecl('a',FloatType()),VarDecl('c',ArrayType(10,FloatType()))]))
        self.assertTrue(TestAST.checkASTGen(input,expect,307))
    def test_vardecl5(self):
        """Simple program: int main() {} """
        input = """string a,c[10];
            """
        expect = str(Program([VarDecl('a',StringType()),VarDecl('c',ArrayType(10,StringType()))]))
        self.assertTrue(TestAST.checkASTGen(input,expect,308))
    def test_vardecl6(self):
        """Simple program: int main() {} """
        input = """boolean a,c[10];
            """
        expect = str(Program([VarDecl('a',BoolType()),VarDecl('c',ArrayType(10,BoolType()))]))
        self.assertTrue(TestAST.checkASTGen(input,expect,309))
    def test_vardecl7(self):
        """Simple program: int main() {} """
        input = """boolean a,c[10]; int a,b;string c[10];
            """
        expect = str(Program([VarDecl('a',BoolType()),VarDecl('c',ArrayType(BoolType(),10)),VarDecl('a',IntType),VarDecl('b',IntType),VarDecl('c',ArrayType(StringType(),10))]))
    ...
    def test_funcdec2(self):
        ...
        expect = str(Program([VarDecl('abc',ArrayType(10,IntType())),FuncDecl(Id('main'),[VarDecl('a',IntType),VarDecl('b',IntType)],ArrayPointerType(IntType),Block([]))]))
    ...
    def test_funcdec4(self):
        ...
        expect = str(Program([FuncDecl(Id('main'),[VarDecl('a',IntType()),VarDecl('b',ArrayPointerType(BoolType()))],IntType(),Block([]))]))
    ...
    def test_more5(self):
        ...
        expect = str(Program([VarDecl('a',FloatType()),VarDecl('d',FloatType()),VarDecl('e',FloatType()),VarDecl('b',StringType()),VarDecl('c',BoolType()),FuncDecl(Id('main'),[],VoidType(),Block([]))]))
    ...
    def test_more7(self):
        ...
        input = """int main(){
            ...
            """
        expect = str(Program([FuncDecl(Id('main'),[],IntType(),Block([VarDecl('a',IntType()),BinaryOp('=',Id('a'),IntLiteral(10)),Return(IntLiteral(1))]))]))
    ...
    def test_more8(self):
        ...
        input = """int main(){
            ...
            """
        expect = str(Program([FuncDecl(Id('main'),[],IntType(),Block([VarDecl('a',IntType()),VarDecl('b',IntType()),BinaryOp('=',Id('a'),IntLiteral(10)),Return(IntLiteral(1))]))]))
    ...
    def test_more9(self):
        ...
        input = """int main(){
            ...
            """
        expect = str(Program([FuncDecl(Id('main'),[],IntType(),Block([VarDecl('a',IntType()),VarDecl('b',IntType()),VarDecl("c",ArrayType(10,IntType())),BinaryOp('=',Id('a'),IntLiteral(10)),Return(IntLiteral(1))]))]))
    ...
    def test_more10(self):
        ...
        input = """int main(){
            ...
            """
        expect = str(Program([FuncDecl(Id('main'),[],IntType(),Block([VarDecl('a',IntType()),VarDecl('b',IntType()),VarDecl('c',IntType()),VarDecl('d',ArrayType(10,IntType())),BinaryOp('=',Id('a'),BinaryOp('+',BinaryOp('-',Id('a'),IntLiteral(10)),BinaryOp('*',IntLiteral(9),IntLiteral(8)))),Return(IntLiteral(1))]))]))
    ...
    def test_more11(self):
        ...
        input = """int main(){
            ...
            """
        expect = str(Program([FuncDecl(Id('main'),[],IntType(),Block([VarDecl('a',IntType()),VarDecl('b',IntType()),VarDecl('c',IntType()),VarDecl('d',ArrayType(10,IntType())),VarDecl('e',ArrayType(9,IntType())),BinaryOp('=',Id('a'),BinaryOp('+',BinaryOp('-',Id('a'),IntLiteral(10)),BinaryOp('*',IntLiteral(9),IntLiteral(8)))),BinaryOp('=',ArrayCell(Id('d'),IntLiteral(0)),BinaryOp('-',BinaryOp('-',ArrayCell(Id('d'),IntLiteral(10)),ArrayCell(Id('e'),IntLiteral(9))),CallExpr(Id('foo'),[]))),Return(IntLiteral(1))]))]))
    ...
    def test_more12(self):
        ...
        input = """int main(){
            ...
            """
        expect = str(Program([FuncDecl(Id('main'),[],IntType(),Block([VarDecl('a',IntType()),VarDecl('b',IntType()),VarDecl('c',IntType()),VarDecl('d',ArrayType(10,IntType())),BinaryOp('=',Id('a'),BinaryOp('+',BinaryOp('-',Id('a'),IntLiteral(10)),BinaryOp('*',IntLiteral(9),IntLiteral(8)))),If(BinaryOp('<=',Id('a'),IntLiteral(1)),BinaryOp('=',Id('a'),IntLiteral(1))),Return(IntLiteral(1))]))]))
    ...
    def test_more13(self):
        ...
        input = """int main(){
            ...
            """
        expect = str(Program([FuncDecl(Id('main'),[],IntType(),Block([VarDecl('a',IntType()),VarDecl('b',IntType()),VarDecl('c',IntType()),VarDecl('d',ArrayType(10,IntType())),BinaryOp('=',Id('a'),BinaryOp('+',BinaryOp('-',Id('a'),IntLiteral(10)),BinaryOp('*',IntLiteral(9),IntLiteral(8)))),If(BinaryOp('<=',Id('a'),IntLiteral(1)),Block([BinaryOp('=',Id('a'),IntLiteral(1))])),Return(IntLiteral(1))]))]))
    ...
    def test_more14(self):
        ...
        input = """int main(){
            ...
            """
        expect = str(Program([FuncDecl(Id('main'),[],IntType(),Block([VarDecl('a',IntType()),VarDecl('b',IntType()),VarDecl('c',IntType()),VarDecl('d',ArrayType(10,IntType())),BinaryOp('=',Id('a'),BinaryOp('+',BinaryOp('-',Id('a'),IntLiteral(10)),BinaryOp('*',IntLiteral(9),IntLiteral(8)))),If(BinaryOp('<=',Id('a'),IntLiteral(1)),Block([BinaryOp('=',Id('a'),IntLiteral(1)),Block([BinaryOp('=',Id('b'),IntLiteral(10)),For(BinaryOp('=',Id('i'),IntLiteral(1)),BinaryOp('>',Id('i'),IntLiteral(10)),BinaryOp('=',Id('i'),BinaryOp('+',IntLiteral(1),IntLiteral(2))),BinaryOp('=',Id('a'),Id('c')))])])),Return(IntLiteral(1))]))]))
    ...
    def test_more15(self):
        ...
        input = """
            ...
            """
        expect = str(Program([VarDecl('k',ArrayType(10,BoolType())),FuncDecl(Id('main'),[],IntType(),Block([VarDecl('a',IntType()),VarDecl('b',IntType()),VarDecl('c',IntType()),VarDecl('d',ArrayType(10,IntType())),BinaryOp('=',Id('a'),BinaryOp('+',BinaryOp('-',Id('a'),IntLiteral(10)),BinaryOp('*',IntLiteral(9),IntLiteral(8)))),Dowhile([Block([])],BinaryOp('<',Id('a'),IntLiteral(3))),BinaryOp('=',Id('a'),IntLiteral(1)),Return(IntLiteral(1))]))]))
    ...
    def test_more16(self):
        ...
        input = """
            ...
            """
        expect = str(Program([FuncDecl(Id('khoa'),[VarDecl('a',IntType()),VarDecl('b',IntType())],BoolType(),Block([Return(BinaryOp('&&',Id('a'),Id('b')))])),FuncDecl(Id('main'),[],IntType(),Block([VarDecl('a',IntType()),VarDecl('b',IntType()),VarDecl('c',IntType()),VarDecl('d',ArrayType(10,IntType())),BinaryOp('=',Id('a'),BinaryOp('+',BinaryOp('-',Id('a'),IntLiteral(10)),BinaryOp('*',IntLiteral(9),IntLiteral(8)))),Dowhile([Block([])],BinaryOp('<',Id('a'),IntLiteral(3))),BinaryOp('=',Id('a'),IntLiteral(1)),Return(IntLiteral(1))]))]))
    ...
    def test_more17(self):
        ...
        input = """
            ...
            """
        expect = str(Program([FuncDecl(Id('khoa'),[VarDecl('a',IntType()),VarDecl('b',IntType())],BoolType(),Block([VarDecl('c',IntType()),Return(BinaryOp('&&',Id('A'),Id('B')))])),FuncDecl(Id('main'),[],IntType(),Block([VarDecl('a',IntType()),VarDecl('b',IntType()),VarDecl('c',IntType()),VarDecl('d',ArrayType(10,IntType())),BinaryOp('=',Id('a'),BinaryOp('+',BinaryOp('-',Id('a'),IntLiteral(10)),BinaryOp('*',IntLiteral(9),IntLiteral(8)))),Dowhile([Block([])],BinaryOp('<',Id('a'),IntLiteral(3))),BinaryOp('=',Id('a'),IntLiteral(1)),Return(IntLiteral(1))]))]))
    ...
    def test_more18(self):
        ...
        expect = str(Program([FuncDecl(Id('main'),[],IntType(),Block([VarDecl('a',IntType()),VarDecl('b',IntType()),VarDecl('c',IntType()),BinaryOp('=',Id('a'),BinaryOp('*',Id('a'),Id('c'))),BinaryOp('==',Id('a'),Id('b'))]))]))
    ...
    def test_more19(self):
        ...
        expect = str(Program([FuncDecl(Id('main'),[],IntType(),Block([VarDecl('a',IntType()),VarDecl('b',IntType()),VarDecl('c',IntType()),BinaryOp('=',Id('a'),BinaryOp('*',Id('a'),Id('c'))),UnaryOp('!',Id('b'))]))]))
    ...
    def test_more20(self):
        ...
        expect = str(Program([FuncDecl(Id('main'),[],IntType(),Block([VarDecl('a',IntType()),VarDecl('b',IntType()),VarDecl('c',IntType()),BinaryOp('=',Id('a'),BinaryOp('*',Id('a'),Id('c'))),BinaryOp('=',Id('b'),BinaryOp('||',Id('a'),BinaryOp('&&',Id('b'),BinaryOp('-',Id('c'),Id('d')))))]))]))
    ...
    def test_more21(self):
        ...
        expect = str(Program([FuncDecl(Id('main'),[],IntType(),Block([VarDecl('a',IntType()),VarDecl('b',IntType()),VarDecl('c',IntType()),VarDecl('d',ArrayType(10,IntType())),BinaryOp('=',Id('a'),BinaryOp('*',Id('a'),Id('c'))),BinaryOp('=',Id('a'),ArrayCell(Id('d'),BinaryOp('+',Id('b'),Id('c'))))]))]))
    ...
    def test_more22(self):
        ...
        expect = str(Program([FuncDecl(Id('main'),[],IntType(),Block([VarDecl('a',IntType()),VarDecl('b',IntType()),VarDecl('c',IntType()),VarDecl('d',ArrayType(10,IntType())),BinaryOp('=',Id('a'),BinaryOp('*',Id('a'),Id('c'))),BinaryOp('=',ArrayCell(CallExpr(Id('foo'),[IntLiteral(2)]),BinaryOp('+',IntLiteral('3'),Id('x'))),BinaryOp('+',ArrayCell(Id('a'),ArrayCell(Id('b'),IntLiteral(2))),IntLiteral(3)))]))]))
    ...
    def test_more247(self):
        ...
        expect = str(Program([FuncDecl(Id('foo'),[],ArrayPointerType(IntType()),Block([Return(Id('k'))])),FuncDecl(Id('main'),[],IntType(),Block([VarDecl('a',IntType()),BinaryOp('=',Id('a'),CallExpr(Id('getFloat'),[])),CallExpr(Id('putString'),[ArrayCell(CallExpr(Id('foo'),[IntLiteral(3)]),IntLiteral(1))])]))]))
    ...
    def test_more29(self):
        ...
        expect = str(Program([FuncDecl(Id('main'),[],IntType(),Block([VarDecl('a',IntType()),VarDecl('b',IntType()),VarDecl('c',IntType()),BinaryOp('=',Id('a'),BinaryOp('*',Id('a'),Id('c'))),BinaryOp('=',Id('b'),BinaryOp('&&',CallExpr(Id('khasd'),[BinaryOp('-',BinaryOp('%',ArrayCell(CallExpr(Id('khak'),[]),BinaryOp('||',Id('a'),BinaryOp('&&',Id('b'),BinaryOp('-',Id('c'),Id('d'))))),IntLiteral(20)),IntLiteral(10))]),Id('a')))]))]))
    ...
    def test_more30(self):
        ...
        expect = str(Program([FuncDecl(Id('main'),[],IntType(),Block([VarDecl('a',IntType()),VarDecl('b',IntType()),VarDecl('c',IntType()),VarDecl('d',ArrayType(10,IntType())),BinaryOp('=',Id('a'),BinaryOp('*',Id('a'),Id('c'))),BinaryOp('=',Id('a'),ArrayCell(Id('d'),BinaryOp('+',Id('b'),Id('c')))),Dowhile([Block([]),Block([])],BinaryOp('!=',BinaryOp('||',Id('a'),IntLiteral(3)),IntLiteral(0)))]))]))
    ...
    def test_more31(self):
        ...
        expect = str(Program([FuncDecl(Id('main'),[],IntType(),Block([VarDecl('a',IntType()),VarDecl('b',IntType()),VarDecl('c',IntType()),VarDecl('d',ArrayType(10,IntType())),BinaryOp('=',Id('a'),BinaryOp('*',Id('a'),Id('c'))),BinaryOp('=',Id('a'),ArrayCell(Id('d'),BinaryOp('+',Id('b'),Id('c')))),Dowhile([BinaryOp('=',Id('a'),BinaryOp('+',Id('a'),ArrayCell(Id('d'),IntLiteral(0)))),BinaryOp('=',Id('b'),BinaryOp('*',Id('b'),Id('c')))],BinaryOp('!=',BinaryOp('||',Id('a'),IntLiteral(3)),IntLiteral(0)))]))]))
    ...
    def test_more34(self):
        ...
        expect = str(Program([VarDecl('a',FloatType()),FuncDecl(Id('main'),[VarDecl('a',IntType()),VarDecl('b',ArrayPointerType(FloatType()))],ArrayPointerType(IntType()),Block([ArrayCell(CallExpr(Id('F'),[IntLiteral(3)]),IntLiteral(5)),Return()]))]))
    ...
    def test_more36(self):
        ...
        expect = "Program([FuncDecl(Id(fooa),[VarDecl(a,ArrayTypePointer(IntType))],IntType,Block([Return(ArrayCell(Id(a),IntLiteral(0)))])),FuncDecl(Id(main),[],VoidType,Block([VarDecl(arr,ArrayType(IntType,10)),VarDecl(f,FloatType),BinaryOp(=,Id(f),IntLiteral(0)),Dowhile([BinaryOp(=,Id(f),BinaryOp(+,Id(f),CallExpr(Id(foo),[Id(arr)]))),BinaryOp(=,Id(f),BinaryOp(+,Id(f),IntLiteral(1)))],BinaryOp(<,BinaryOp(+,CallExpr(Id(foo),[Id(arr)]),Id(f)),IntLiteral(100))),Return()]))])"
    ...
    def test_more37(self):
        ...
        expect = str(Program([VarDecl("a", IntType()), VarDecl("bb", FloatType()), VarDecl("c", StringType()), VarDecl("d", ArrayType(10, IntType())), FuncDecl(Id("main"), [], VoidType(), Block([Block([]), Return()]))]))
    ...
    def test_more39(self):
        ...
        expect = str(Program([FuncDecl(Id("main"), [], IntType(), Block([VarDecl("aa", IntType()), VarDecl("bb", IntType()), VarDecl("cc", IntType()), VarDecl("d", IntType())]))]))
        self.assertTrue(TestAST.checkASTGen(input, expect, 389))
    
    def test_more40(self):
        """ """
        input = """int main(){int a[20],b,c,d;}"""
        expect = str(Program([FuncDecl(Id("main"), [], IntType(), Block([VarDecl("a", ArrayType(
                                                                                                20, IntType())), VarDecl("b", IntType()), VarDecl("c", IntType()), VarDecl("d", IntType())]))]))
    ...
    def test_more41(self):
        ...
        expect = str(Program([FuncDecl(Id("main"), [], IntType(), Block(
                                                                        [VarDecl("aaa", ArrayType(12, IntType()))]))]))
    ...
    def test_more42(self):
        ...
        expect = str(Program([FuncDecl(Id('foo'),[VarDecl('a',IntType()),VarDecl('b',ArrayPointerType(FloatType()))],ArrayPointerType(IntType()),Block([VarDecl('c',ArrayType(10,IntType())),If(BinaryOp('>',Id('a'),IntLiteral(0)),CallExpr(Id('foo'),[BinaryOp('-',Id('a'),IntLiteral(1)),Id('b')]),Return(Id('c')))]))]))
    ...
    def test_more45(self):
        ...
        expect = str(Program([FuncDecl(Id("main"),[],IntType(),Block([VarDecl("checking",BoolType()),BinaryOp("=",Id("checking"),BooleanLiteral(True))]))]))
    ...
    def test_more52(self):
        ...
        input = """
            ...
            """
        expect = str(Program([VarDecl('a',IntType()),VarDecl('b',FloatType()),VarDecl('c',StringType()),VarDecl('d',BoolType())]))
        self.assertTrue(TestAST.checkASTGen(input, expect, 600))
